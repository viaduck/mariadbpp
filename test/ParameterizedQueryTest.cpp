...
#define ParamTest_TEST(call, call2, name, value)  errorQuery = m_con->create_statement("UPDATE " + m_table_name + " SET " + name + "= ?;"); \
	...
	ParamTest_TEST(errorQuery->set_unsigned32(0, (unsigned int) 299), queryResult->get_unsigned32(0), "preis", 299);
	ParamTest_TEST(errorQuery->set_string(0, "TESTSTRING"), queryResult->get_string(0), "str", "TESTSTRING");
