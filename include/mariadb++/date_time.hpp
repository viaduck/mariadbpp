...
namespace mariadb
{
	...
	public:
        ...
        /**
         * Construct date_time from ISO yyyy-mm-dd hh:mm:ss.nnn date format. Throws an exception on invalid input
         *
		...
		/**
		 * Calculates the time_span between this date_time and dt. If dt > this the time_span will be negative
		 *
        ...
        /**
         * Indicates whether a given date is valid in terms of existing month and day in month. Accounts for leap years
         *
